...
function getAppointments(searchString) {
		...
		$("#appointmentTable").append("<table id=\"appointmentTable\" class=\"table\"><thead><tr><th scope=\"col\">Date</th><th scope=\"col\">Time</th><th scope=\"col\">Description</th></tr></thead>");
	                        $.ajax({
                            type: 'GET',
                            ...
                            success: function(appointments) {
								...
								$("#appointmentTable").append("<tbody><tr>" + appointments.appointmentDate + "</tr><tr>" + appointments.appointmentTime + "</tr><tr>" +appointments.description + "</tr></tbody>");
								}
                                                    },
